...
Um ponto que reforça a validade desta recomendação é a robustez estatística do experimento. O teste alcançou um poder estatístico de 87,11%, superando a meta de 80% definida para o estudo. Isso indica que a análise teve uma alta probabilidade de detectar as diferenças reais entre os retornos das ações e que o número de amostras utilizado foi mais que suficiente.

Como sugestão para aprimorar futuras análises, poderiam ser considerados horizontes de tempo mais longos, que capturem diferentes ciclos de mercado. Além disso, a inclusão de outras variáveis, como indicadores fundamentalistas ou o sentimento do mercado, poderia complementar a análise baseada puramente em retornos históricos, oferecendo uma visão ainda mais completa para a tomada de decisão.
